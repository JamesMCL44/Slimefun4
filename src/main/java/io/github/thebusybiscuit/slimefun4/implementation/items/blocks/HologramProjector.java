...
public class HologramProjector extends SlimefunItem {
    ...
    private static void openEditor(Player p, Block projector) {
        ...
        menu.addItem(1, new CustomItem(Material.CLOCK, "&7微調: &e" + DoubleHandler.fixDouble(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), OFFSET_PARAMETER)) + 1.0D), "", "&r左點擊: &7+0.1", "&r右點擊: &7-0.1"));

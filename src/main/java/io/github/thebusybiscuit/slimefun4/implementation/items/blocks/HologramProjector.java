...
public class HologramProjector extends SlimefunItem implements HologramOwner {
    ...
    private BlockPlaceHandler onPlace() {
        return new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(BlockPlaceEvent e) {
                ...
                BlockStorage.addBlockInfo(b, "text", "透過投影器修改我");
    ...
    private static void openEditor(Player p, Block projector) {
        ...
        menu.addItem(0, new CustomItem(Material.NAME_TAG, "&7SAPS科技生存 &e(點擊修改)", "", "&r" + ChatColors.color(BlockStorage.getLocationInfo(projector.getLocation(), "text"))));
        ...
        menu.addItem(1, new CustomItem(Material.CLOCK, "&7微調: &e" + NumberUtils.roundDecimalNumber(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), OFFSET_PARAMETER)) + 1.0D), "", "&r左點擊: &7+0.1", "&r右點擊: &7-0.1"));
